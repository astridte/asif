...
def get_mep_file(self, mep_file_path):
		try:
			dataset = pd.read_excel(mep_file_path, engine='openpyxl')
		except :
...
class Person():
	...
	def get_dataset(self):# The dataset 
		return self.dataset
	...
	def get_ID(self):             # ID provided in the file
		return self.ID
...
#########################################################
	...
	def get_firstName_db(self):
		full = self.get_fullName_db()
		fn, _ = self.find_space_tab(full)
		return fn

	def get_lastName_db(self):
		full = self.get_fullName_db()
		_, ln = self.find_space_tab(full)
		return ln

	def get_functions_db(self):
		try:
